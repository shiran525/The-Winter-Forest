...
Shader "Winter Environment/Standard Snow Tessellation"
{
	Properties
	{
		...
		_SnowSharpness("Snow Sharpness", Range( 0 , 10)) = 1
		...
		_TessMin( "Tess Min Distance", Float ) = 8
		_TessMax( "Tess Max Distance", Float ) = 50
		_TessPhongStrength( "Phong Tess Strength", Range( 0, 1 ) ) = 0.688
	...
	SubShader
	{
		...
		uniform half _SnowAccumulation;
		uniform half _SnowSharpness;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#endif
			float _snowMask126 = saturate( pow( ( saturate( normalize( WorldNormalVector( i , staticSwitch67 ) ).y ) * _SnowAccumulation ) , _SnowSharpness ) );
			float4 lerpResult42 = lerp( float4( staticSwitch67 , 0.0 ) , staticSwitch86 , _snowMask126);
			...
			#endif
			float4 lerpResult13 = lerp( lerpResult75 , staticSwitch84 , _snowMask126);
			...
			#endif
			float lerpResult87 = lerp( ( staticSwitch90 * _SmoothnessStrength ) , staticSwitch115 , _snowMask126);
			...
			float4 lerpResult46 = lerp( tex2DNode12 , lerpResult57 , _snowMask126);
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf Standard keepalpha fullforwardshadows noinstancing dithercrossfade vertex:vertexDataFunc tessellate:tessFunction tessphong:_TessPhongStrength 
...
/*ASEBEGIN
Version=15301
167;45;1666;962;9541.311;3928.193;9.283525;True;True
...
Node;AmplifyShaderEditor.TriplanarNode;63;-3319.6,1533.286;Float;True;Spherical;World;True;DetailNormal;_DetailNormal;white;21;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Detail Normal;False;9;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;8;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;2;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BlendNormalsNode;64;-2416.629,372.2563;Float;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;108;-2049.645,479.2378;Float;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;67;-1790.94,346.7518;Float;False;Property;_UseDetailMap;Use Detail Map;19;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TriplanarNode;62;-3328.2,1328.986;Float;True;Spherical;World;False;DetailAlbedo;_DetailAlbedo;white;20;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Detail Albedo;False;9;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;8;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;2;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldNormalVector;28;-1356.861,777.9012;Float;False;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;98;-2576.252,1409.564;Float;False;Constant;_Float4;Float 4;26;0;Create;True;0;0;False;0;1.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-952.6862,1069.73;Half;False;Property;_SnowAccumulation;Snow Accumulation;14;0;Create;True;0;0;False;0;1;1.7;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;128;-1059.807,818.3875;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;-5277.89,3.04718;Float;False;Property;_SnowUVScale;Snow UV Scale;13;0;Create;True;0;0;False;0;0.2;0.17;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;65;-1338.246,-261.9244;Float;True;ColorDodge;True;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-611.4595,1064.385;Half;False;Property;_SnowSharpness;Snow Sharpness;15;0;Create;True;0;0;False;0;1;4;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-5224.484,320.0734;Float;False;Property;_SnowNormalIntensity;Snow Normal Intensity;17;0;Create;True;0;0;False;0;5;1.7;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-785.1042,816.3311;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;37;-479.5583,816.9973;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-561.1338,-316.1002;Float;False;Property;_DetailAlbedoStrength;Detail Albedo Strength;24;0;Create;True;0;0;False;0;0;0.802;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;114;-222.3984,824.5562;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;86;-2564.839,-105.7687;Float;False;Property;_UseSnowTexture;Use Snow Texture;12;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;84;-2564.716,-337.9163;Float;False;Property;_UseSnowTexture;Use Snow Texture;7;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;127;-146.0598,17.14203;Float;False;126;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;126;2.620759,830.3619;Float;False;_snowMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2881.873,-185.5201;Float;False;True;6;Float;ASEMaterialInspector;0;0;Standard;Winter Environment/Standard Snow Tessellation;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;True;False;False;Back;0;False;-1;0;False;-1;False;0;0;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;0;4;8;50;True;0.688;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;-1;False;-1;-1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;2;-1;-1;25;0;0;0;False;0;0;0;False;-1;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=8E3A10F8E449F788D0A4F4255C6609AF8D3A2A83